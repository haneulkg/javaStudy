...
public class SungjukService {
	...
	public void setInput() {
		...
		while(true) {
			...
			// 동명2인 처리(같은 성명자료는 입력하지 않음)
			
			int res = dao.setInput(vo);
			
			if(res == 0) System.out.println("성적 등록이 실패되었습니다.");
			else System.out.println(vo.getName()+"님의 성적이 등록되었습니다.");
			
			System.out.print("성적 입력을 계속 하시겠습니까?(y/n) >> ");
			ans = scanner.next();
	...
	public void setSearch() {
		while(true) {
			...
			else System.out.println("검색하신 "+name+"님은 존재하지 않습니다.");
